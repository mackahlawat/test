...
public class EmployeeDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		String maxEmployeeManager = findMangerWithMaxEmployees(employeeList);
		System.out.println("Manager with maximum employees is " + maxEmployeeManager);

	}

	private static String findMangerWithMaxEmployees(List<Employee> employees) {
	...
	public static double findMaxSalary(List<Employee> employees) {
		Map<Double,Employee> map = new TreeMap<Double, Employee>();
		for(Employee employee : employees) {
